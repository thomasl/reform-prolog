 ...
 * Implementation:
 *
 *   Sun specific definitions supporting parallel execution.
 *
 *
     ...
     long globalsize;           /* Size of shared memory area     */
{
   ...
   */
  if ((globalstart = (char *) mmap((caddr_t) globalstart, globalsize,
   ...
   * even if the program terminates unnaturally
   */
